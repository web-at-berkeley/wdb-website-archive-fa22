			...
			<Container fluid className="body">
				...
				<Row className="justify-content-center">
					<Col xs={12} md={4} className="relative-container left-container">
						<Link href="/about/education" className="inner-container">
							<a className="inner-container">
								...
								<p className="subject-text">
									...
									pursuing this knowledge. Web Developers of Berkeley is the
									place for students to master these skills and web developers
					...
					<Col xs={12} md={4} className="relative-container right-container">
						<Link href="/about/development" className="inner-container">
							<a className="inner-container">
				...
				<Row className="justify-content-center">
					<Link href="/about/partnerships" className="partner-link">
						<a className="partner-link">
							...
							>
								...
								<p className="subject-text">
									As a member of the Berkeley tech community, part of our
									mission is to provide web development services to fellow UC
									Berkeley organizations and associated non-profits, giving back
									to the community and prioritizing tech for social good.
								</p>
							</Col>
						</a>
					</Link>
