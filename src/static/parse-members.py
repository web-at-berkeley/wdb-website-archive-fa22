...
columns = []
data = {}
with open("roster-sp23.csv", encoding="utf8") as csv_file:
    ...
    for row in csv_reader:
        if not parsedHeader:
            ...
            if methodOfLeaving != "" and (
                methodOfLeaving != "Graduated" or methodOfLeaving != "Personal Choice"
            ):
                continue
            ...
            data[str(uuid.uuid4())] = {
                ...
                "lastName": lastName,
                "nickname": nickname,
                "image": "{fN}-{lN}-{ind}.jpg".format(
                    fN=firstName.lower(), lN=lastName.lower(), ind=index
                ),
